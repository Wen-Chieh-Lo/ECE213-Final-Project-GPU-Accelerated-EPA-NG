...
//PLL_EXPORT void pll_core_update_partial_ii_4x4_avx_fp32(unsigned int sites,
//                                                   unsigned int rate_cats,
//                                                   float * parent_clv,
//                                                   unsigned int * parent_scaler,
//                                                   const float * left_clv,
//                                                   const float * right_clv,
...
//    scale_mask = init_mask;
//
//    for (k = 0; k < rate_cats; k+=2)
//    {
//      /* compute vector of x */
//      xmmd = _mm256_load_pd(lmat);
//      xmm0h = _mm256_cvtpd_ps(xmmd);
//      xmmd = _mm256_load_pd(lmat+4*states);
//      xmm1h = _mm256_cvtpd_ps(xmmd);
//      xmm4 = _mm256_set_m128(xmm1h,xmm0h);
//
//      xmmd = _mm256_load_pd(left_clv);
//      xmm0h = _mm256_cvtpd_ps(xmmd);
//      xmmd = _mm256_load_pd(left_clv+states);
//      xmm1h = _mm256_cvtpd_ps(xmmd);
//      xmm5 = _mm256_set_m128(xmm1h,xmm0h);
//
//      xmm0 = _mm256_mul_ps(xmm4,xmm5);
//
//      ymmd = _mm256_load_pd(rmat);
//      ymm0h = _mm256_cvtpd_ps(ymmd);
//      ymmd = _mm256_load_pd(rmat+4*states);
//      ymm1h = _mm256_cvtpd_ps(ymmd);
//      ymm4 = _mm256_set_m128(ymm1h,ymm0h);
//
//      ymmd = _mm256_load_pd(right_clv);
//      ymm0h = _mm256_cvtpd_ps(ymmd);
//      ymmd = _mm256_load_pd(right_clv+states);
//      ymm1h = _mm256_cvtpd_ps(ymmd);
//      ymm5 = _mm256_set_m128(ymm1h,ymm0h);
//
//      ymm0 = _mm256_mul_ps(ymm4,ymm5);
//
//      lmat += states;
//      rmat += states;
//
...
//
//      /* compute x */
//      xmm4 = _mm256_unpackhi_ps(xmm0,xmm1);
//      xmm5 = _mm256_unpacklo_ps(xmm0,xmm1);
//
//      xmm6 = _mm256_unpackhi_ps(xmm2,xmm3);
//      xmm7 = _mm256_unpacklo_ps(xmm2,xmm3);
//
//      xmm0 = _mm256_add_ps(xmm4,xmm5);
//      xmm1 = _mm256_add_ps(xmm6,xmm7);
//
//      xmm2 = _mm256_shuffle_ps(xmm0,xmm1,78);
//      xmm3 = _mm256_blend_ps(xmm0,xmm1,204);
//      xmm4 = _mm256_add_ps(xmm2,xmm3);
//
//      /* compute y */
//      ymm4 = _mm256_unpackhi_ps(ymm0,ymm1);
//      ymm5 = _mm256_unpacklo_ps(ymm0,ymm1);
//
//      ymm6 = _mm256_unpackhi_ps(ymm2,ymm3);
//      ymm7 = _mm256_unpacklo_ps(ymm2,ymm3);
//
//      ymm0 = _mm256_add_ps(ymm4,ymm5);
//      ymm1 = _mm256_add_ps(ymm6,ymm7);
//
//      ymm2 = _mm256_shuffle_ps(ymm0,ymm1,78);
//      ymm3 = _mm256_blend_ps(ymm0,ymm1,204);
//
//      ymm4 = _mm256_add_ps(ymm2,ymm3);
//
//      /* compute x*y */
//      xmm0 = _mm256_mul_ps(xmm4,ymm4);
//      xmmd = _mm256_cvtps_pd(_mm256_extractf128_ps(xmm0, 0));
//      /* check if scaling is needed for the current rate category */
//      __m256d v_cmp = _mm256_cmp_pd(xmmd, v_scale_threshold, _CMP_LT_OS);
//      const unsigned int rate_mask = _mm256_movemask_pd(v_cmp);
//
//      if (scale_mode == 2)
//      {
...
//        if (rate_mask == 0xF)
//        {
//          xmmd = _mm256_mul_pd(xmmd,v_scale_factor);
//          parent_scaler[n*rate_cats + k] += 1;
//        }
//      }
//      else
//        scale_mask = scale_mask & rate_mask;
//
//      _mm256_store_pd(parent_clv, xmmd);
//      //printf("%.10lf, %.10lf, %.10lf, %.10lf\n",parent_clv[0],parent_clv[1],parent_clv[2],parent_clv[3]);
//
//      xmmd = _mm256_cvtps_pd(_mm256_extractf128_ps(xmm0, 1));
//      /* check if scaling is needed for the current rate category */
//      v_cmp = _mm256_cmp_pd(xmmd, v_scale_threshold, _CMP_LT_OS);
//      const unsigned int rate_mask_2 = _mm256_movemask_pd(v_cmp);
//
//      if (scale_mode == 2)
//      {
//        /* PER-RATE SCALING: if *all* entries of the *rate* CLV were below
...
//        {
//          xmmd = _mm256_mul_pd(xmmd,v_scale_factor);
//          parent_scaler[n*rate_cats + k + 1] += 1;
//        }
//      }
//      else
//        scale_mask = scale_mask & rate_mask_2;
//
//      _mm256_store_pd(parent_clv+states, xmmd);
//      //printf("%.10lf, %.10lf, %.10lf, %.10lf\n",parent_clv[4],parent_clv[5],parent_clv[6],parent_clv[7]);
//
//      parent_clv += 2*states;
//      left_clv   += 2*states;
//      right_clv  += 2*states;
                                                   ...
                                                   unsigned int attrib)
{
  ...
  __m256  xmm0,xmm1,xmm2,xmm3,xmm4,xmm5,xmm6,xmm7;
  __m128  xmm128_0, xmm128_1, xmm128_2, xmm128_3;
  __m256  xmm_res_0,xmm_res_1;
  ...
  unsigned int scale_mask;
  unsigned int init_mask;
  __m128 v_scale_threshold = _mm_set1_ps(PLL_SCALE_THRESHOLD);
  __m128 v_scale_factor = _mm_set1_ps(PLL_SCALE_FACTOR);
  ...
  for (n = 0; n < sites; ++n)
  {
    ...
    for (k = 0; k < rate_cats; k+=4)
    {
      /* compute vector of x */
      xmm5 = _mm256_load_ps(left_clv);
      xmm4 = _mm256_loadu2_m128(lmat + 4*states, lmat);
      xmm0 = _mm256_mul_ps(xmm4,xmm5);

      ymm5 = _mm256_load_ps(right_clv);
      ymm4 = _mm256_loadu2_m128(rmat + 4*states, rmat);
      ymm0 = _mm256_mul_ps(ymm4,ymm5);
      ...
      ymm4 = _mm256_add_ps(ymm2,ymm3);
      /* compute x*y */
      xmm_res_0 = _mm256_mul_ps(xmm4,ymm4);

      /* compute vector of x */
      xmm5 = _mm256_load_ps(left_clv + 2*states);
      xmm4 = _mm256_loadu2_m128(lmat + 4*states, lmat);
      xmm0 = _mm256_mul_ps(xmm4,xmm5);

      ymm5 = _mm256_load_ps(right_clv + 2*states);
      ymm4 = _mm256_loadu2_m128(rmat + 4*states, rmat);
      ymm0 = _mm256_mul_ps(ymm4,ymm5);
      ...
      /* compute x*y */
      xmm_res_1 = _mm256_mul_ps(xmm4,ymm4);
      /* check if scaling is needed for the current rate category */
      xmm128_0 = _mm256_extractf128_ps(xmm_res_0, 0);
      __m128 v_cmp = _mm_cmp_ps(xmm128_0, v_scale_threshold, _CMP_LT_OS);
      const unsigned int rate_mask_0 = _mm_movemask_ps(v_cmp);

      xmm128_1 = _mm256_extractf128_ps(xmm_res_0, 1);
      v_cmp = _mm_cmp_ps(xmm128_1, v_scale_threshold, _CMP_LT_OS);
      const unsigned int rate_mask_1 = _mm_movemask_ps(v_cmp);

      xmm128_2 = _mm256_extractf128_ps(xmm_res_1, 0);
      v_cmp = _mm_cmp_ps(xmm128_2, v_scale_threshold, _CMP_LT_OS);
      const unsigned int rate_mask_2 = _mm_movemask_ps(v_cmp);

      xmm128_3 = _mm256_extractf128_ps(xmm_res_1, 1);
      v_cmp = _mm_cmp_ps(xmm128_3, v_scale_threshold, _CMP_LT_OS);
      const unsigned int rate_mask_3 = _mm_movemask_ps(v_cmp);
      ...
      if (scale_mode == 2)
      {
        ...
        if (rate_mask_0 == 0xF)
        {
          xmm128_0 = _mm_mul_ps(xmm128_0,v_scale_factor);
          parent_scaler[n*rate_cats + k] += 1;
        }
        if (rate_mask_1 == 0xF)
        {
          xmm128_1 = _mm_mul_ps(xmm128_1,v_scale_factor);
          parent_scaler[n*rate_cats + k + 1] += 1;
        }
        if (rate_mask_2 == 0xF)
        {
          xmm128_2 = _mm_mul_ps(xmm128_2,v_scale_factor);
          parent_scaler[n*rate_cats + k + 2] += 1;
        }
        if (rate_mask_3 == 0xF)
        {
          xmm128_3 = _mm_mul_ps(xmm128_3,v_scale_factor);
          parent_scaler[n*rate_cats + k +3] += 1;
        }
      }
      else
        scale_mask = scale_mask & rate_mask_0 & rate_mask_1 & rate_mask_2 & rate_mask_3;

      _mm_store_ps(parent_clv, xmm128_0);
      _mm_store_ps(parent_clv+1*states, xmm128_1);
      _mm_store_ps(parent_clv+2*states, xmm128_2);
      _mm_store_ps(parent_clv+3*states, xmm128_3);
      //printf("%.10lf, %.10lf, %.10lf, %.10lf\n",parent_clv[0],parent_clv[1],parent_clv[2],parent_clv[3]);
    ...
    if (scale_mask == 0xF)
    {
      ...
      for (i = 0; i < span; i += 4)
      {
        __m128 v_prod = _mm_load_ps(parent_clv + i);
        v_prod = _mm_mul_ps(v_prod,v_scale_factor);
        _mm_store_ps(parent_clv + i, v_prod);
      }
      parent_clv += span;
      parent_scaler[n] += 1;
    }
...
PLL_EXPORT void pll_core_update_partial_ii_4x4_avx_fp32_small(unsigned int sites,
                                                   unsigned int rate_cats,
                                                   float * parent_clv,
                                                   unsigned int * parent_scaler,
                                                   const float * left_clv,
                                                   ...
                                                   unsigned int attrib)
{
  ...
  for (n = 0; n < sites; ++n)
  {
    ...
    {
      /* compute vector of x */
      xmm4 = _mm_load_ps(lmat);
      xmm5 = _mm_load_ps(left_clv);
      xmm0 = _mm_mul_ps(xmm4,xmm5);

      ymm4 = _mm_load_ps(rmat);
      ymm5 = _mm_load_ps(right_clv);
      ymm0 = _mm_mul_ps(ymm4,ymm5);
      ...
      ymm4 = _mm_load_ps(rmat);
      ymm2 = _mm_mul_ps(ymm4,ymm5);

      lmat += states;
      rmat += states;

      xmm4 = _mm_load_ps(lmat);
      xmm3 = _mm_mul_ps(xmm4,xmm5);

      ymm4 = _mm_load_ps(rmat);
      ymm3 = _mm_mul_ps(ymm4,ymm5);
      ...
      xmm5 = _mm_unpacklo_ps(xmm0,xmm1);

      xmm6 = _mm_unpackhi_ps(xmm2,xmm3);
      xmm7 = _mm_unpacklo_ps(xmm2,xmm3);

      xmm0 = _mm_add_ps(xmm4,xmm5);
      xmm1 = _mm_add_ps(xmm6,xmm7);

      xmm2 = _mm_shuffle_ps(xmm0,xmm1,78);
      xmm3 = _mm_blend_ps(xmm0,xmm1,12);
      xmm4 = _mm_add_ps(xmm2,xmm3);

      /* compute y */
      ymm4 = _mm_unpackhi_ps(ymm0,ymm1);
      ymm5 = _mm_unpacklo_ps(ymm0,ymm1);

      ymm6 = _mm_unpackhi_ps(ymm2,ymm3);
      ymm7 = _mm_unpacklo_ps(ymm2,ymm3);

      ymm0 = _mm_add_ps(ymm4,ymm5);
      ymm1 = _mm_add_ps(ymm6,ymm7);

      ymm2 = _mm_shuffle_ps(ymm0,ymm1,78);
      ymm3 = _mm_blend_ps(ymm0,ymm1,12);
      ymm4 = _mm_add_ps(ymm2,ymm3);

      /* compute x*y */
      xmm0 = _mm_mul_ps(xmm4,ymm4);
      /* check if scaling is needed for the current rate category */
      __m128 v_cmp = _mm_cmp_ps(xmm0, v_scale_threshold, _CMP_LT_OS);
      const unsigned int rate_mask = _mm_movemask_ps(v_cmp);
      ...
      if (scale_mode == 2)
      {
        ...
        if (rate_mask == 0xF)
        {
          xmm0 = _mm_mul_ps(xmm0,v_scale_factor);
          parent_scaler[n*rate_cats + k] += 1;
        }
      }
      else

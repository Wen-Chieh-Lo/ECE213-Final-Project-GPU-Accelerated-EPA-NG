...
#define PLL_SCALE_FACTOR 18446744073709551616.0f  /*  2**64 (exactly)  */
#define PLL_SCALE_THRESHOLD (1.0f/PLL_SCALE_FACTOR)
#define PLL_SCALE_FACTOR_SQRT 4294967296.0f /* 2**16 */
#define PLL_SCALE_THRESHOLD_SQRT (1.0f/PLL_SCALE_FACTOR_SQRT)
...
#define PLL_MISC_EPSILON 1e-8f
#define PLL_ONE_EPSILON 1e-15f
#define PLL_ONE_MIN (1-PLL_ONE_EPSILON)
#define PLL_ONE_MAX (1+PLL_ONE_EPSILON)
#define PLL_EIGEN_MINFREQ 1e-6f
...
PLL_EXPORT float pll_compute_root_loglikelihood(pll_partition_t * partition,
                                                 unsigned int clv_index,
                                                 int scaler_index,
                                                 const unsigned int * freqs_indices,
                                                 float * persite_lnl);

PLL_EXPORT float pll_compute_edge_loglikelihood(pll_partition_t * partition,
                                                 unsigned int parent_clv_index,
                                                 int parent_scaler_index,
...
PLL_EXPORT float pll_core_edge_loglikelihood_ii(unsigned int states,
                                                 unsigned int sites,
                                                 unsigned int rate_cats,
                                                 const float * parent_clv,
                                                 const unsigned int * parent_scaler,
                                                 const float * child_clv,
                                                 const unsigned int * child_scaler,
                                                 const float * pmatrix,
                                                 float * const * frequencies,
                                                 const float * rate_weights,
                                                 const unsigned int * pattern_weights,
                                                 const float * invar_proportion,
                                                 const int * invar_indices,
                                                 const unsigned int * freqs_indices,
                                                 float * persite_lnl,
                                                 unsigned int attrib);

PLL_EXPORT float pll_core_edge_loglikelihood_ti(unsigned int states,
                                                 unsigned int sites,
                                                 unsigned int rate_cats,
                                                 const float * parent_clv,
                                                 const unsigned int * parent_scaler,
...
PLL_EXPORT float pll_core_edge_loglikelihood_ti_4x4(unsigned int sites,
                                                     unsigned int rate_cats,
                                                     const float * parent_clv,
                                                     const unsigned int * parent_scaler,
                                                     const unsigned char * tipchars,
...
PLL_EXPORT float pll_core_root_loglikelihood_repeats(unsigned int states,
                                                      unsigned int sites,
                                                      unsigned int rate_cats,
                                                      const float * clv,
...
PLL_EXPORT float pll_core_edge_loglikelihood_repeats(unsigned int states,
                                                      unsigned int sites,
...
PLL_EXPORT float pll_core_edge_loglikelihood_repeats_generic(unsigned int states,
                                      unsigned int sites,
                                      const unsigned int child_sites,
                                      unsigned int rate_cats,
                                      const float * parent_clv,
...
PLL_EXPORT float pll_core_root_loglikelihood(unsigned int states,
                                              unsigned int sites,
                                              unsigned int rate_cats,
                                              const float * clv,
                                              const unsigned int * scaler,
...
PLL_EXPORT float pll_core_root_loglikelihood_4x4_avx(unsigned int sites,
                                                      unsigned int rate_cats,
                                                      const float * clv,
                                                      const unsigned int * scaler,
                                                      float * const * frequencies,
...
PLL_EXPORT int pll_core_update_pmatrix(float ** pmatrix,
                                       unsigned int states,
                                       unsigned int rate_cats,
                                       const float * rates,
                                       const float * branch_lengths,
